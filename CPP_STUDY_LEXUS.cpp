// CPP_STUDY_LEXUS.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
int main()
{
    ...
    while (health >= 1)
    {
        std::cout << "Type ur damage/heal\n";
        std::cin >> item_impact;
        std::cout << "Type ur distance\n";
